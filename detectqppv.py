...
def detect(D,D_list,msk,wl,nrp,cth,n_itr_th,mx_itr,pfs,nsubj,nrn):
    if  msk.endswith('.nii'):
    ...
    #mx_itr=15
    #pf2 =
    f = qppv(B, msk, nd, wl, nrp, cth, n_itr_th, mx_itr, pfs)
...
if __name__ == "__main__":
    ...
    detect(D,D_list,args.msk,args.wl,args.nrp,args.cth,args.n_itr_th,args.mx_itr,args.pfs,args.nsubj,args.nrn)