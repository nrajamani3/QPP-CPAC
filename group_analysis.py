...
class QPPSettings(wx.ScrolledWindow):
    ...
    def __init__(self, parent, counter=0):
        ...
        self.page = GenericClass(self, " QPP-Quasi Periodic Properties")
        ...
        self.page.add(label="Window Length,(wl) ",
                      ...
                      type=dtype.NUM,
                      values=30,
                      comment="Window length will be a function of the TR. It is the number of timepoints you would like to "
                              "search for patterns within. ")

        self.page.add(label="Number of scans ",
                      control=control.INT_CTRL,
                      name='qpp_nd',
                      type=dtype.NUM,
                      comment="Total number of scans.",
                      values=20)

        self.page.add(label="Number of repetitions,(nrp) ",
                      control=control.INT_CTRL,
                      name='qpp_nrp',
                      type=dtype.NUM,
                      comment="Number of random initial segments to inspect ",
                      values=20)


        self.page.add(label="Correlation Threshold(cth) ",
                      control=control.CHOICE_BOX,
                      name='qpp_cth',
                      type=dtype.LNUM,
        ...
        self.page.add(label="Number Of Early Iterations",
                      control=control.INT_CTRL,
                      name='qpp_n_iter_th1',
                      type=dtype.NUM,
                      values="2",
                      comment="Number of early iterations with the lower correlation threshold, set to 1 to 3.")
